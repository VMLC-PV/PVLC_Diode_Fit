...
# def test_NonIdealDiode_light(J0,n,Rs,Rsh,Jph,T,show_plot=False):
#     """ Test the NonIdealDiode function
...
#     # Solve non-ideal diode equation in the dark
#     print(Rsh,Rs,J0,n)
#     V = np.arange(0,3,0.001) # Voltage [V]
#     J = NonIdealDiode_light(V, J0, n, Rs, Rsh, Jph, T)
#     Jdark = NonIdealDiode_dark(V, J0, n, Rs, Rsh, T)

#     kb = constants.value(u'Boltzmann constant in eV/K')
#     Vt = kb*T
#     print(J + Jph - J0*(np.exp(-(V-J*Rs)/(n*Vt)) - 1) - (V - J*Rs)/Rsh)
#     # plt.plot(V,J,V,-Jph+Jdark,'o')
#     # plt.semilogy(V,abs(J+Jdark),'o')
#     # plt.xlim(0,1.2)
#     # plt.ylim(-250,10)
#     plt.show()
...
if __name__ == "__main__":
    ...
    # for i in list(itertools.product(J0,n,Rs,Rsh,Jph,T)):
    #     test_NonIdealDiode_light(i[0],i[1],i[2],i[3],i[4],i[5])
